...
function App() {
  ...
  const passwordGenerator = useCallback(() => {
    let pass = '';
    let str = 'ABCDEFGHIJKLMNOPQRSTQVWXYZabcdefghijklmnopqrstuvwxzy';
  ...
  return (
    <>
      ...
      rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-700'>
        ...
        <h1 className='text-4xl text-center mt-4 text-white my-3'>Password Generator</h1>
